...
<html lang="en">
  ...
  <body>
    ...
    <div class="content row">
        <?php $__currentLoopData = $kaset; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kasets): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card-box h-100">
                <h3>Lagu: <?php echo e($kasets->lagu); ?></h3>
                <p>Deskripsi: <?php echo e($kasets->deskripsi); ?></p>
                <p>Rak: <?php echo e($kasets->rak); ?></p>
            </div>
        </div>
...
<?php /**PATH D:\XAMPP\htdocs\meseum\resources\views/UserPage/Musik/Kaset/pagekasetindonesia.blade.php ENDPATH**/ ?>