...
<html lang="en">
  ...
  <body>
    ...
    <div class="content row">
        <?php $__currentLoopData = $piringanhitam; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $piringanhitams): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card-box h-100">
                <h3>Lagu: <?php echo e($piringanhitams->lagu); ?></h3>
                <p>Deskripsi: <?php echo e($piringanhitams->deskripsi); ?></p>
                <p>Rak: <?php echo e($piringanhitams->rak); ?></p>
            </div>
        </div>
...
<?php /**PATH D:\XAMPP\htdocs\meseum\resources\views/UserPage/Musik/PiringanHitam/piringanhitamindonesia.blade.php ENDPATH**/ ?>