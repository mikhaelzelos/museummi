...
<html lang="en">
  ...
  <body>
    ...
    <div class="box">
      <?php $__currentLoopData = $alatmusik_modern; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alatmusikmodern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div>
        <h1>Nama Instrumen: <?php echo e($alatmusikmodern->nama_instrumen); ?></h1>
        <h1>Quantity: <?php echo e($alatmusikmodern->quantity); ?></h1>
      </div>
...
<?php /**PATH D:\XAMPP\htdocs\meseum\resources\views/UserPage/alat_musik/alat_musik_modern.blade.php ENDPATH**/ ?>