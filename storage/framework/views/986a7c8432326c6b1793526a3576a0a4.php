...
<html lang="en">
  ...
  <body>
    ...
    <div class="ukuran">
        <h1 style="text-align: center; margin-top: 1%;">CD</h1>
    </div>
    <div class="content row">
        <?php $__currentLoopData = $cd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card-box h-100">
                <h3>Lagu: <?php echo e($cds->lagu); ?></h3>
                <p>Deskripsi: <?php echo e($cds->deskripsi); ?></p>
                <p>Rak: <?php echo e($cds->rak); ?></p>
            </div>
        </div>
...
<?php /**PATH D:\XAMPP\htdocs\meseum\resources\views/UserPage/Musik/CD/CDIndonesia.blade.php ENDPATH**/ ?>