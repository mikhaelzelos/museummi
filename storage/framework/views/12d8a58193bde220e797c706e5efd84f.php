...
<html lang="en">
  ...
  <body>
    ...
    <div class="content row">
        <?php $__currentLoopData = $buku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bukus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card-box h-100">
                <h3>Judul: <?php echo e($bukus->judul); ?></h3>
                <p>Deskripsi: <?php echo e($bukus->deskripsi); ?></p>
                <p>Rak: <?php echo e($bukus->rak); ?></p>
            </div>
        </div>
...
<?php /**PATH D:\XAMPP\htdocs\meseum\resources\views/UserPage/Artikel/buku.blade.php ENDPATH**/ ?>