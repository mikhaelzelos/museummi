...
<html lang="en">
  ...
  <body>
    ...
    <div class="content row">
        <?php $__currentLoopData = $majalah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $majalahs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card-box h-100">
                <h3>Judul: <?php echo e($majalahs->judul); ?></h3>
                <p>Deskripsi: <?php echo e($majalahs->deskripsi); ?></p>
                <p>Rak: <?php echo e($majalahs->rak); ?></p>
            </div>
        </div>
...
<?php /**PATH D:\XAMPP\htdocs\meseum\resources\views/UserPage/Artikel/majalah.blade.php ENDPATH**/ ?>