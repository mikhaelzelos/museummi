  ...
  <body>
    ...
    <div class="container-image-logo">
        <div class="image-logo-1">
          <div class="content">
            <a href="/user/kaset"><img src="/Img/kaset.png" style="margin-left: 45%;" alt="" class="drum"></a>
            <h4 style="margin-bottom: 5%; margin-left: 60%;">Kaset</h4> 
          </div>
        </div>
        <div class="logo2">
             <img src="/Img/logo musik.png" style="margin-left: 85%;" alt="" class="not">
             <h4 style="margin-left: 100%;">Musik</h4>
        </div>
       <div class="image-logo-4">
        <div class="content">
          <a href="/user/cd"> <img src="/Img/cd.png" alt="" class="drumtwo"></a>
          <h4 style="margin-left: -19%;">CD</h4> 
        </div>
      </div>   
        <div class="image-logo-3">
          <div class="content">
            <a href="/user/piringanhitam"> <img src="/Img/piringan_hitam_1x1-removebg-preview.png" alt="" class="drumtri"></a>
            <h4 style="margin-bottom: 20%;">Piringan Hitam</h4>
          </div>
        </div>
      </div>
...
</html><?php /**PATH D:\XAMPP\htdocs\meseum\resources\views/UserPage/Musik/PageMusik.blade.php ENDPATH**/ ?>