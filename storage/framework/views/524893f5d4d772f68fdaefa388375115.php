  ...
  <body>
    ...
    <div class="container-image-logo">
        <div class="image-logo-1">
          <div class="content">
           <a href="/artikel/buku"><img src="/Img/logo buku.png" style="margin-left: 35%;" alt="" class="drum"></a>
            <h4 style="margin-bottom: 5%; margin-left: 50%;">Buku</h4> 
          </div>
        </div>
        <div class="logo2">
             <img src="/Img/majalah_1x1-removebg-preview.png" style="margin-left: 50%; margin-top: 6%;" alt="" class="not">
             <h4 style="margin-left: 80%; text-align: center;">Artikel</h4>
        </div>
       <div class="image-logo-4">
        ...
        <div class="image-logo-3">
          <div class="content">
            <a href="/artikel/majalah"> <img src="/Img/majlaah.png" class="drumtri"></a>
            <h4 style="margin-bottom: 25%; margin-left: 10%;">Majalah</h4>
          </div>
        </div>
      </div>
...
</html><?php /**PATH D:\XAMPP\htdocs\meseum\resources\views/UserPage/Artikel/artikel.blade.php ENDPATH**/ ?>