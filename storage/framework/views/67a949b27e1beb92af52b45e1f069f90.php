    ...
    <div class="col-lg-10"> <!-- Adjust column width as needed -->
        <div class="card" style="border-radius: 39px;">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('instrumentradisional.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nama_instrumen" name="nama_instrumen" class="form-control" placeholder="Tanggal Masuk">
                    </div>

                    <div class="form-group">
                        <label for="daerah">daerah:</label>
                        <input type="text" id="daerah" name="daerah" class="form-control" placeholder="daerah">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="quantity" name="quantity" class="form-control" placeholder="Deskripsi">
                    </div>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\meseum\resources\views/instrumentradisional/create.blade.php ENDPATH**/ ?>