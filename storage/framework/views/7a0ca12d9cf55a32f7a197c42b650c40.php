...
<html lang="en">
  ...
  <body>
    ...
    <div class="content row">
        <?php $__currentLoopData = $memorabilia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $memorabilias): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card-box h-100">
                <h3>Biografi: <?php echo e($memorabilias->Biografi); ?></h3>
                <p>Nama: <?php echo e($memorabilias->nama); ?></p>
                <p>Dekripsi: <?php echo e($memorabilias->deskripsi); ?></p>
            </div>
        </div>
...
<?php /**PATH D:\XAMPP\htdocs\meseum\resources\views/UserPage/Memorabilia/foto.blade.php ENDPATH**/ ?>