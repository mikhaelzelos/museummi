            ...
            <div class="card-body">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nomor_regist" name="nomor_regist" class="form-control" placeholder="nomor_regist" value="{{ $instrumenmodern->nomor_regist}}">
                    </div>

                    <div class="form-group">
                        <label for="nama_instrumen">nama_instrumen:</label>
                        <input type="text" id="nama_instrumen" name="nama_instrumen" class="form-control" placeholder="nama_instrumen"  value="{{ $instrumenmodern->nama_instrumen}}">
                    </div>
